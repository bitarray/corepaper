...
#+revision[20200617]: Added additional description about the scheduler design for message loop.
#+revision[20200622]: Added actor groups, system actor descriptions, and specific actor design on information fetcher.
